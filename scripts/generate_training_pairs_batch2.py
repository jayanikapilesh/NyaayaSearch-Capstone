...
EXISTING_FILE = os.path.join(os.path.dirname(__file__), "..", "data", "training_pairs.jsonl")
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), "..", "data", "training_pairs_batch2.jsonl")
