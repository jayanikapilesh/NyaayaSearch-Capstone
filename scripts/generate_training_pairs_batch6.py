...
EXISTING_FILES = [
    ...
    os.path.join(os.path.dirname(__file__), "..", "data", "training_pairs_batch4.jsonl"),
    os.path.join(os.path.dirname(__file__), "..", "data", "training_pairs_batch5.jsonl"),
]
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), "..", "data", "training_pairs_batch6.jsonl")
