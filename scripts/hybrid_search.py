...
for index in top_indices:
    ...
    print("\n----------------------------")
    print("Act:", record.get("act_name"))
    print("Section:", record.get("section_number"))
    print("Title:", record.get("section_title"))
    print("Hybrid Score:", final_scores[index])
    print("Semantic Score:", semantic_scores[index])
    print("BM25 Score:", bm25_scores[index])