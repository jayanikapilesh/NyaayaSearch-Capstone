...
configs = [
    {
        "input": "data/processed/motor_vehicles_act_1988.txt",
        "output": "Legal_Knowledge_Base_motor_vehicles_fixed.xlsx",
    ...
    {
        "input": "data/processed/bharatiya_nagarik_suraksha_sanhita_2023.txt",
        "output": "Legal_Knowledge_Base_bnss_fixed.xlsx",
    ...
    {
        "input": "data/processed/domestic_violence_act_2005.txt",
        "output": "Legal_Knowledge_Base_dv_fixed.xlsx",
...
for cfg in configs:
    ...
    start = starts[-1].start() + 1  # +1 to skip the \n
    text2 = text[start:]
