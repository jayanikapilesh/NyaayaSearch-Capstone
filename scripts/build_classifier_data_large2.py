...
# Source 1: original eval queries (42 tuned)
...
# Source 2b: 380 additional AI-generated, spot-checked query->section pairs (batch 2)
with open("../data/training_pairs_batch2.jsonl", "r", encoding="utf-8") as f:
    for line in f:
        pair = json.loads(line)
        queries_and_targets.append((pair["query"], pair["act_name"], str(pair["section_number"])))

# Source 3: held-out batches 1-4 (55 genuinely verified queries, previously unused for classifier training)
holdout_all = [
