...
export const HOME_CONTENT = {
  ...
  hi: {
    ...
    workflowSteps: [
      ...
      { title: "सरल भाषा में व्याख्या पाएं", description: "देखें कि कानून का आपके लिए क्या अर्थ है, हर उद्धरण अपने स्रोत धारा तक जाने योग्य है।" },
    ...
    featureCards: [
      ...
      { tab: "simplifier", title: "मामला सरलीकरण", description: "किसी अदालती फैसले को पेस्ट करें और सरल भाषा में सारांश पाएं।" },
